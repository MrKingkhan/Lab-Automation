...
<body class="main-layout" style="background-color: aliceblue;">
   <!-- loader  -->
   ...
   <center>
      <p1 style="position: relative;bottom: -40px;font-family:Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif;font-size: 30px;">We are locally owned and operated which makes our services causal as they
         <br>are done by friendly and helpful technicians.
      </p1>
   </center>
      ...
      <div class="container">
         <div class="row">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
               <div class="about_box">
                  <h3>Our Services</h3>
                  <p>All of our services are backed by our 100% satisfaction guarantee. Our electricians can install anything from new security lighting for your outdoors to a whole home generator that will keep your appliances working during a power outage. Our installation services are always done promptly and safely.
                  <ul type="1" style="color: black;">
                     <br>
